...
{{-- <div class="row"> --}}
    ...
    <a href="{{ route('admin.suratin.show', $model)}}" class="btn btn-info modal-show edit" title="{{ $model->name }}" style="font-size:13px;"><i class="fas fa-search"></i></a>

    <a href="{{ route('admin.suratin.edit', $model)}}" class="btn btn-warning modal-show edit" title="{{ $model->name }}" style="font-size:13px;"><i class="fas fa-edit"></i></a>
