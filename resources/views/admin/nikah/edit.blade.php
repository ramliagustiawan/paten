                                    ...
                                    <div class="card">
                                            ...
                                            <div class="row justify-content-center mt-4">
                                                  ...
                                                  <div class="col-xs-10 col-md-10 col-lg-10 mt-1">
                                                      ...
                                                      <form action="{{ route('admin.nikah.update',$dispensasi) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method("PUT")
                                            ...
                                            {{--  --}}
                                                        ...
                                                        <div class="form-group mt-2">
                                                            ...
                                                            <a href="{{ route('admin.nikah.qrcode', $dispensasi)}}" class="btn btn-info modal-show edit" >Generate Qrcode</a>
                                                        </div>
