...
class NikahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.nikah.index')->withSuccess('Permohonan Dispensasi Nikah Berhasil Di Tambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $this->validate($request, [
        ...
        return redirect()->route('admin.nikah.edit', $dispensasi)->withInfo('Permohonan Dispensasi Nikah ' . $dispensasi->nama . ' valid');
    }
    ...
    public function destroy($id)
    {
        ...
        $dispensasi->delete();
        // dd($dispensasi);
        return redirect()->route('admin.nikah.index')
    ...
    public function qrcode($id)
    {
        ...
        return redirect()->route('admin.nikah.index')->withSuccess('Qrcode Generate  permohonan : ' . $dispensasi->nama . ' Siap Cetak');
    }

    public function cetak($id)
    {
        $dispensasi = Dispensasi::find($id);
        $pdf = PDF::loadView('admin.nikah.cetak', [
            'dispensasi' => $dispensasi,
